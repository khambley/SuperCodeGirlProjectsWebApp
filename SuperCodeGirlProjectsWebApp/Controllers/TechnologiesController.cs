...
namespace SuperCodeGirlProjectsWebApp.Controllers
{
    public class TechnologiesController : Controller
    {
        ...
        public TechnologiesController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TechnologyId,Name,IconPath,ProjectId")] Technology technology)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TechnologyId,Name,IconPath,ProjectId")] Technology technology)
        {
